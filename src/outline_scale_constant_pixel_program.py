...
class OutlineScaleConstantPixelProgram(Program):

    def __init__(self, main_program, line_size):
        super(OutlineScaleConstantPixelProgram, self).__init__()
        self.main_program = main_program
        self.line_size = line_size

    def load_uniform_locations(self, gl_program):
        super(OutlineScaleConstantPixelProgram, self).load_uniform_locations(gl_program)
